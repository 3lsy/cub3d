...
# define EELMAP "Empty line inside the map."
...
# define EMMAP "Missing map element 🗺️"
# define EMTEXT "Missing texture elements at the top of the config 🎨"
# define EMCOLOR "Missing color elements at the top of the config 🎨"
